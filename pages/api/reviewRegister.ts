...
export const reviewRegister = async (registerForm: IReviewRegisterApiType) => {
  const reviewRegsiter = await instance.post(`/reviewers/${registerForm.reviewerId}/reviews`, {
...
export const reviewModify = async (modifyForm: IReviewModifyApiType) => {
  const reviewModify = await instance.patch(`/reviewers/${modifyForm.reviewerId}/reviews/${modifyForm.reviewId}`, {
